...
│   ├── hero.tsx                # fixed line + rotating value line (Framer, ~2.2s), pills, dual CTA, illustrative preview card
...
└── results/
    ...
    ├── live-example-panel.tsx  # right-rail auto-cycling "Sample output" showcase (fictional UFC-fighter demo candidates, full evaluation)
